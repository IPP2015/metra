...
function AppServer() {
  ...
  this.server.put('/api/users/v1', jwtAuth.verifyToken, userHandler.updateDataUser);

  this.server.post('/v1/customers/auth/register', basicAuth.isAuthenticated, customerHandler.registerCustomer);
  // Admin
  this.server.post('/v1/admin', basicAuth.isAuthenticated, adminHandler.registerAdmin);
  // Admin - Roles
  this.server.post('/v1/admin/role', basicAuth.isAuthenticated, adminHandler.createRole);
